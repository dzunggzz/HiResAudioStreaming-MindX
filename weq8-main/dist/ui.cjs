...
`,qe=[["noop","Add +"],["lowpass12","LP12"],["lowpass24","LP24"],["highpass12","HP12"],["highpass24","HP24"],["lowshelf12","LS12"],["lowshelf24","LS24"],["highshelf12","HS12"],["highshelf24","HS24"],["peaking12","PK12"],["peaking24","PK24"],["notch12","NT12"],["notch24","NT24"]];var U;let R=(U=class extends q{constructor(){super(),this.frequencyInputFocused=!1,this.dragStates={frequency:null,gain:null,Q:null},this.addEventListener("click",()=>this.dispatchEvent(new CustomEvent("select",{composed:!0,bubbles:!0})))}render(){if(!this.runtime||this.index===void 0)return;let e=qe.filter(i=>this.runtime.supportedFilterTypes.includes(i[0])),t=this.runtime.spec[this.index];return m`
      <th>
        <div
    ...
    `]})(),U);c([x({attribute:!1})],R.prototype,"runtime",void 0);c([x()],R.prototype,"index",void 0);c([b()],R.prototype,"frequencyInputFocused",void 0);c([b()],R.prototype,"dragStates",void 0);R=c([ie("weq8-ui-filter-row")],R);var N;let $=(N=class extends q{constructor(){super(...arguments),this.x=0,this.y=0,this.frequencyInputFocused=!1,this.dragStates={frequency:null,gain:null,Q:null},this.posOnDragStart=null}render(){var r,a,h,l;if(!this.runtime||this.index===void 0)return;let e=qe.filter(o=>this.runtime.supportedFilterTypes.includes(o[0])),t=this.runtime.spec[this.index],i=((a=(r=this.posOnDragStart)==null?void 0:r.x)!=null?a:this.x)-100,s=((l=(h=this.posOnDragStart)==null?void 0:h.y)!=null?l:this.y)+20;return console.log("hi",i,s),m`
